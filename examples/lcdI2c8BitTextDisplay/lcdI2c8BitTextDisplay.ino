...
FLProgTextDisplayTextField firstField(1, 5, "Screen 1");
FLProgTextDisplayTextField firstField1(2, 1, "Test1");

FLProgTextDisplayScreen secondScreen(2);
FLProgTextDisplayTextField secondField(1, 8, "Screen 2");
...
void setup()
{
  ...
  firstScreen.addField(&secondField);
  firstScreen.addField(&secondField1);
}
